		...
		if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
			if (toInterfaceOrientation == UIInterfaceOrientationLandscapeLeft || toInterfaceOrientation == UIInterfaceOrientationLandscapeRight) {
				if ([[UIScreen mainScreen] scale] == 2) {
					launchImage.image = [UIImage imageNamed:@"2048x1536.png"];
				} else {
					launchImage.image = [UIImage imageNamed:@"1024x768.png"];
				}
				launchImage.frame = CGRectMake(0.0f, 0.0f, 1024.0f, 768.0f);
			} else if (toInterfaceOrientation == UIInterfaceOrientationPortrait || toInterfaceOrientation == UIInterfaceOrientationPortraitUpsideDown) {
				if ([[UIScreen mainScreen] scale] == 2) {
					launchImage.image = [UIImage imageNamed:@"1536x2048.png"];
				} else {
					launchImage.image = [UIImage imageNamed:@"768x1024.png"];
				}
